...
//     try {
//         let lastLetter = users.filter((item) => item.firstName.endsWith("q"));
//         if (lastLetter.length == 0) {
//             throw new Error("q ile biten soz yoxdur");
//         }
//         console.log("q ile biten sozler:", lastLetter.map(item => item.firstName));
...
// const usersAge =()=>{
//     try {
//         let ageUsers = users.filter(item => item.age>100)
//         if(ageUsers.length==0){
//             throw new Error("yasi 100-den yuxari olan istifadeci movcud deyil")
//         }
//         console.log("yaslari 100-den yuxari olan istifadeciler:", ageUsers.map(item=>item.age));
...
//     }finally{
//         console.log("istifadecilerin yaslari:", users.map(item=>item.age));
//     }
